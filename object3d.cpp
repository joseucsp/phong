...
Object3D::Object3D(std::string filename, float scale){
	...
	Texture1     = 0;
	Texture2     = 0;
	Texture1 	= loadBMP_custom("data/merc/textures/merc.bmp");
	Texture2 	= loadBMP_custom("data/merc/textures/norm.bmp");
	ModelMatrix = glm::mat4(1.0);
	lightPos 	= glm::vec4(4,4,1,0);
...
void Object3D::setShaders(std::string vfile,std::string ffile){
	...
	std::cout<<"load Shaders : "<< vfile.c_str() << ", "<< ffile.c_str() <<std::endl;
